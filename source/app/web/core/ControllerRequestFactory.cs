...
namespace app.web.core
{
    public class ControllerRequestFactory : ICreateControllerRequests
    {
        ...
        public ControllerRequestFactory(IGetViewNameFromRequest view_name_parser, IGetActionNameFromRequest action_name_parser)
        {
        ...
        {
            return new RequestDetails(() => a_raw_aspnet_request, view_name_parser, action_name_parser);
        }
    }
}